		...
		<div class="container">
			<div class="row">
				<div class="offset-3 col-6">
					<h1 class="text-center">Gym Management</h1>
					<div class="tab" role="tabpanel">
						<form class="tab-content tabs" action="<?php  echo $_SERVER['PHP_SELF']; ?>" method="POST">
							<div role="tabpanel" class="tab-pane active" id="Section1">
								<h3>Welcome to Gym Management</h3>
								<p>Introducing Gym Management - a complete management solution to manage your Members, Memberships, Staff Members, Member Groups, Member Attendance, Reports & etc.</p>
