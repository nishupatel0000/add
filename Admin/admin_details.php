...
<div class="container">
    ...
    <!-- Section for Adding Chefs -->
    <div class="card mb-4">
        <div class="card-header bg-danger text-white">
            <h2 class="h5 mb-0">Chefs</h2>
        </div>
        <div class="card-body">
            <form id="chefs" enctype="multipart/form-data">
            <div class="mb-3">
                    <label for="image" class="form-label">Image</label>
                    <input type="file" name="chef_image" id="image" class="form-control"  >
                ...
                <div class="mb-3">
                    <label for="title" class="form-label">Title</label>
                    <input type="text" name="chef_title" id="chef_title" class="form-control" placeholder="Enter   title">
                    <div id="chef_title_err" class="error"></div>

                </div>
                <div class="mb-3">
                    <label for="designation" class="form-label">Designation</label>
                    <input type="text" name="chef_designation" id="designation" class="form-control" placeholder="Enter designation">
                ...
                <div class="mb-3">
                    <label for="content" class="form-label">Description</label>
                    <textarea name="chef_description" id="content" class="form-control" placeholder="Enter description"></textarea>
...
<script>
    ...
    let forms = ['add_user', 'add_about', 'add_categories', 'testimonial','chefs'];
    forms.forEach(id => {
