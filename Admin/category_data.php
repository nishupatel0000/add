...
if ($_POST['action'] == "food_insert") {
  ...
  if (!empty($error)) {
    ...
    $insert_categories = "insert into menu(title,description,price,image,category_id)values('$category_title','$category_description','$category_price','$newFileName','$type')";
